...
namespace Advent
{
    class Program
    {
        ...
        //    {
        //        var passReq = password.Split(':')[0];
        //        var pass = password.Split(':')[1].Trim();

        //        var firstLetterIndex = Convert.ToInt32(passReq.Split('-')[0]);
        //        var secondLetterIndex = Convert.ToInt32(passReq.Split('-')[1].Split(' ')[0]);
        //        var letterReq = Convert.ToChar(passReq.Split(' ')[1]);

        //        if ((pass[firstLetterIndex - 1] == letterReq && pass[secondLetterIndex - 1] != letterReq)
        //            || (pass[firstLetterIndex - 1] != letterReq && pass[secondLetterIndex - 1] == letterReq))
        //            validCount++;
        //    }
