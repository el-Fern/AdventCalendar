...
namespace Advent
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Bags that are inside a shiny gold bag: " + TotalBagsInside("shiny gold"));
        }
        ...
        private static int TotalBagsInside(string bag)
        {
            ...
            {
                bagsContained += (containRule.Count * TotalBagsInside(containRule.Bag)) + containRule.Count;
            }
